...
class BinanceAPI
{
    ...
    */
    ...
    public function cancelOrderx($symbol, $orderId)
    {
        $data = [
            'symbol'   => $symbol,
            'orderId'     => $orderId,
    ...
    public function cancelOrder($symbol, $orderid)
    {
        ...
        // Set URL & Header
        curl_setopt($this->curl, CURLOPT_URL, $this->url . "v3/order?{$query}&signature={$sign}");
    ...
    public function getOrderx($symbol, $orderid)
    {
        $data = [
            'symbol'   => $symbol,
            'orderId'     => $orderid,

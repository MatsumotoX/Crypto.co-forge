...
const getCOData = suffix => {
  return fetch(
    `https://cors-anywhere.herokuapp.com/https://api.coinone.co.kr/orderbook/?currency=${suffix}&format=json`
  );
};

const getKKData = suffix => {
  return fetch(
    `https://cors-anywhere.herokuapp.com/https://api.kraken.com/0/public/Depth?pair=${suffix}`
  );
};

const getPOData = suffix => {
  return fetch(
    `https://cors-anywhere.herokuapp.com/https://poloniex.com/public?command=returnOrderBook&currencyPair=${suffix}&depth=30`
  );
};
  ...
  Promise.all([
    ...
    Promise.all([
          ...
          if (market[i] == "BX" && currency[j] == "ETC") continue;
            ...
            eval(
              '$("#' +
                ...
                "-" +
                currency[j] +
                '_buychoice").text( "₩ " + parseFloat(buy' +
                currency[j] +
                "_" +
                market[i] +
                ").toFixed(0));"
            ...
            eval(
              '$("#' +
                ...
                "-" +
                currency[j] +
                '_sellchoice").text( "₩ " + parseFloat(sell' +
                currency[j] +
                "_" +
                market[i] +
                ").toFixed(0));"
      ...
      document.getElementById("KK-CO_BTC_oneWay").innerHTML = (
        (((fundAmountKK / buyBTC_KK_fee - feeWD_BTC_KK) * sellBTC_CO_fee -
          fundAmountKK * 1073.7) /
          (fundAmountKK * 1073.7)) *
        100
      ).toFixed(2);
      ...
      document.getElementById("KK-CO_ETH_oneWay").innerHTML = (
        (((fundAmountKK / buyETH_KK_fee - feeWD_ETH_KK) * sellETH_CO_fee -
          fundAmountKK * 1073.7) /
          (fundAmountKK * 1073.7)) *
        100
      ).toFixed(2);
      ...
      document.getElementById("KK-CO_XRP_oneWay").innerHTML = (
        (((fundAmountKK / buyXRP_KK_fee - feeWD_XRP_KK) * sellXRP_CO_fee -
          fundAmountKK * 1073.7) /
          (fundAmountKK * 1073.7)) *
        100
      ).toFixed(2);
      ...
      document.getElementById("KK-CO_ETC_oneWay").innerHTML = (
        (((fundAmountKK / buyETC_KK_fee - feeWD_ETC_KK) * sellETC_CO_fee -
          fundAmountKK * 1073.7) /
          (fundAmountKK * 1073.7)) *
        100
      ).toFixed(2);
      ...
      document.getElementById("KK-PO_BTC_oneWay").innerHTML = (
        (((fundAmountKK / buyBTC_KK_fee - feeWD_BTC_KK) * sellBTC_PO_fee -
          fundAmountKK) /
          fundAmountKK) *
        100
      ).toFixed(2);
      ...
      document.getElementById("KK-PO_ETH_oneWay").innerHTML = (
        (((fundAmountKK / buyETH_KK_fee - feeWD_ETH_KK) * sellETH_PO_fee -
          fundAmountKK) /
          fundAmountKK) *
        100
      ).toFixed(2);
      ...
      document.getElementById("KK-PO_XRP_oneWay").innerHTML = (
        (((fundAmountKK / buyXRP_KK_fee - feeWD_XRP_KK) * sellXRP_PO_fee -
          fundAmountKK) /
          fundAmountKK) *
        100
      ).toFixed(2);
      ...
      document.getElementById("KK-PO_ETC_oneWay").innerHTML = (
        (((fundAmountKK / buyETC_KK_fee - feeWD_ETC_KK) * sellETC_PO_fee -
          fundAmountKK) /
          fundAmountKK) *
        100
      ).toFixed(2);
      ...
      document.getElementById("CO-PO_BTC_oneWay").innerHTML = (
        (((fundAmountCO / buyBTC_CO_fee - feeWD_BTC_CO) * sellBTC_PO_fee -
          fundAmountCO * 0.00093) /
          (fundAmountCO * 0.00093)) *
        100
      ).toFixed(2);

      document.getElementById("CO-PO_ETH_oneWay").innerHTML = (
        (((fundAmountCO / buyETH_CO_fee - feeWD_ETH_CO) * sellETH_PO_fee -
          fundAmountCO * 0.00093) /
          (fundAmountCO * 0.00093)) *
        100
      ).toFixed(2);
      ...
      document.getElementById("CO-PO_XRP_oneWay").innerHTML = (
        (((fundAmountCO / buyXRP_CO_fee - feeWD_XRP_CO) * sellXRP_PO_fee -
          fundAmountCO * 0.00093) /
          (fundAmountCO * 0.00093)) *
        100
      ).toFixed(2);
      ...
      document.getElementById("CO-PO_ETC_oneWay").innerHTML = (
        (((fundAmountCO / buyETC_CO_fee - feeWD_ETC_CO) * sellETC_PO_fee -
          fundAmountCO * 0.00093) /
          (fundAmountCO * 0.00093)) *
        100
      ).toFixed(2);
      ...
      document.getElementById("CO-KK_BTC_oneWay").innerHTML = (
        (((fundAmountCO / buyBTC_CO_fee - feeWD_BTC_CO) * sellBTC_KK_fee -
          fundAmountCO * 0.00093) /
          (fundAmountCO * 0.00093)) *
        100
      ).toFixed(2);
      ...
      document.getElementById("CO-KK_ETH_oneWay").innerHTML = (
        (((fundAmountCO / buyETH_CO_fee - feeWD_ETH_CO) * sellETH_KK_fee -
          fundAmountCO * 0.00093) /
          (fundAmountCO * 0.00093)) *
        100
      ).toFixed(2);
      ...
      document.getElementById("CO-KK_XRP_oneWay").innerHTML = (
        (((fundAmountCO / buyXRP_CO_fee - feeWD_XRP_CO) * sellXRP_KK_fee -
          fundAmountCO * 0.00093) /
          (fundAmountCO * 0.00093)) *
        100
      ).toFixed(2);
      ...
      document.getElementById("CO-KK_ETC_oneWay").innerHTML = (
        (((fundAmountCO / buyETC_CO_fee - feeWD_ETC_CO) * sellETC_KK_fee -
          fundAmountCO * 0.00093) /
          (fundAmountCO * 0.00093)) *
        100
      ).toFixed(2);
      ...
      document.getElementById("PO-KK_BTC_oneWay").innerHTML = (
        (((fundAmountPO / buyBTC_PO_fee - feeWD_BTC_PO) * sellBTC_KK_fee -
          fundAmountPO) /
          fundAmountPO) *
        100
      ).toFixed(2);
      ...
      document.getElementById("PO-KK_ETH_oneWay").innerHTML = (
        (((fundAmountPO / buyETH_PO_fee - feeWD_ETH_PO) * sellETH_KK_fee -
          fundAmountPO) /
          fundAmountPO) *
        100
      ).toFixed(2);
      ...
      document.getElementById("PO-KK_XRP_oneWay").innerHTML = (
        (((fundAmountPO / buyXRP_PO_fee - feeWD_XRP_PO) * sellXRP_KK_fee -
          fundAmountPO) /
          fundAmountPO) *
        100
      ).toFixed(2);
      ...
      document.getElementById("PO-KK_ETC_oneWay").innerHTML = (
        (((fundAmountPO / buyETC_PO_fee - feeWD_ETC_PO) * sellETC_KK_fee -
          fundAmountPO) /
          fundAmountPO) *
        100
      ).toFixed(2);
      ...
      document.getElementById("PO-CO_BTC_oneWay").innerHTML = (
        (((fundAmountPO / buyBTC_PO_fee - feeWD_BTC_PO) * sellBTC_CO_fee -
          fundAmountPO * 1073.7) /
          (fundAmountPO * 1073.7)) *
        100
      ).toFixed(2);
      ...
      document.getElementById("PO-CO_ETH_oneWay").innerHTML = (
        (((fundAmountPO / buyETH_PO_fee - feeWD_ETH_PO) * sellETH_CO_fee -
          fundAmountPO * 1073.7) /
          (fundAmountPO * 1073.7)) *
        100
      ).toFixed(2);
      ...
      document.getElementById("PO-CO_XRP_oneWay").innerHTML = (
        (((fundAmountPO / buyXRP_PO_fee - feeWD_XRP_PO) * sellXRP_CO_fee -
          fundAmountPO * 1073.7) /
          (fundAmountPO * 1073.7)) *
        100
      ).toFixed(2);
      ...
      document.getElementById("PO-CO_ETC_oneWay").innerHTML = (
        (((fundAmountPO / buyETC_PO_fee - feeWD_ETC_PO) * sellETC_CO_fee -
          fundAmountPO * 1073.7) /
          (fundAmountPO * 1073.7)) *
        100
      ).toFixed(2);
